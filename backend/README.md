...
## Project Structure
    ...
    ├── testapiautosetting_124074  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_124074`
...
2. Clone this repo and `cd testapiautosetting_124074`
